...
|------|------|-------------|
| 8位 | 灰度值0-255 | 1字节 |
| 16位 | 灰度值0-65535或-32768-32767 | 2字节 |
...
| 功能 | 说明 |
|------|------|
| 自动刷新 | 修改任何参数后，图像和十六进制视图自动更新 |
| 无需重载 | 不需要重新加载文件 |
| 智能显示 | 十六进制视图只显示当前图像数据范围 |

## 视图切换

| 标签页 | 说明 | 内容 |
|--------|------|------|
| 图像视图 | 显示解析后的图像 | 可缩放、查看像素信息 |
| 十六进制视图 | 显示原始二进制数据 | 地址、十六进制、ASCII |
| 直方图 | 显示像素值分布 | 统计信息、分布图 |
